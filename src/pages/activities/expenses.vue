<script setup lang="ts">
  ...
  onMounted(() => { GeneratorFunctionForLists(componentDependencies, "ActivitiesTimeEntries", renderLoading, errorToDisplay, endpointUrl)})
  ...
  viewWrapper.setPageTitle('Activities Expenses')

  useHead({
    title: 'Lex Algeria - Activities Expenses',
  })
</script>
