<script setup lang="ts">
  ...
  const endpointUrl    = API_URLs.ACTIVITIES__ACTIVITY_ITEMS
  ...
  onMounted(() => { GeneratorFunctionForLists(componentDependencies, "ActivityItems", renderLoading, errorToDisplay, endpointUrl)})
  ...
  viewWrapper.setPageTitle('Activity Items')

  useHead({
    title: 'Lex Algeria - Activity Items',
  })
</script>
