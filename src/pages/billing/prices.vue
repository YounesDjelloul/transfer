<script setup lang="ts">
  ...
  const endpointUrl    = API_URLs.BILLING__PRICES
  ...
  onMounted(() => { GeneratorFunctionForLists(componentDependencies, "BillingPrices", renderLoading, errorToDisplay, endpointUrl)})
  ...
  viewWrapper.setPageTitle('Billing Prices')

  useHead({
    title: 'Lex Algeria - Billing Prices',
  })
</script>
