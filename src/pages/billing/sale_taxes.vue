<script setup lang="ts">
  ...
  const endpointUrl    = API_URLs.BILLING__SALE_TAXES
  ...
  onMounted(() => { GeneratorFunctionForLists(componentDependencies, "BillingSaleTaxes", renderLoading, errorToDisplay, endpointUrl)})
  ...
  viewWrapper.setPageTitle('Billing Sale Taxes')

  useHead({
    title: 'Lex Algeria - Billing Sale Taxes',
  })
</script>
