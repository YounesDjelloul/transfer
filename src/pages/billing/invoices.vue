<script setup lang="ts">
  ...
  onMounted(() => { GeneratorFunctionForLists(componentDependencies, "BillingInvoices", renderLoading, errorToDisplay, endpointUrl)})
  ...
  viewWrapper.setPageTitle('Billing Invoices')

  useHead({
    title: 'Lex Algeria - Billing Invoices',
  })
</script>
